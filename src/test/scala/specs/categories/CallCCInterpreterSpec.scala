...
/** 
 * c.f. http://www.scala-lang.org/node/46
 * 
 * 内部で継続モナド continuation monad を利用している。
...
class CallCCInterpreterSpec extends FunSpec with ShouldMatchers {
  
  
  describe("callCCInterpreter を確認する") {
    it("test"){
      import callccInterpreter._
